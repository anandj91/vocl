...
int main(int argc, char* argv[]) {
    ...
    cl_command_queue queue1 = clCreateCommandQueue(context, device_id[0], 0, &ret);
    cl_command_queue queue2 = clCreateCommandQueue(context, device_id[1], 0, &ret);
    ...
    cl_event init_a;
    ret = clEnqueueNDRangeKernel(queue1, init, 1, NULL, 
    ...
    ret = clSetKernelArg(init, 1, sizeof(int), (void *)&a);
    cl_event init_b;
    ret = clEnqueueNDRangeKernel(queue2, init, 1, NULL, 
    ...
    cl_event vecadd_a;
    ret = clEnqueueNDRangeKernel(queue1, vecadd, 1, NULL, 
    ...
    cl_event vecadd_b;
    ret = clEnqueueNDRangeKernel(queue2, vecadd, 1, NULL, 
    ...
    cl_event read_c;
    ret = clEnqueueReadBuffer(queue1, c_mem_obj, CL_FALSE, 0, 
    ...
    ret = clReleaseCommandQueue(queue1);
    ret = clReleaseCommandQueue(queue2);
